package com.bunny.woodenfish.view;
...
public class RandomAnimation extends RelativeLayout {
    ...
    public RandomAnimation(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public RandomAnimation(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public RandomAnimation(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init() {
        ...
        Drawable lightGreen = getResources().getDrawable(R.drawable.light_green);
        Drawable lightBlue = getResources().getDrawable(R.drawable.light_blue);
        Drawable brown = getResources().getDrawable(R.drawable.brown);
        ...
        drawables[5] = purple;
        drawables[6] = orange;
        drawables[7] = lightGreen;
        drawables[8] = lightBlue;
        drawables[9] = brown;
        //获取图的宽高 用于后面的计算
        //注意 我这里3张图片的大小都是一样的,所以我只取了一个
        dHeight = red.getIntrinsicHeight() / 4;
        dWidth = red.getIntrinsicWidth() / 4;
    ...
    public void addView() {
        ...
        //随机选一个
        imageView.setImageDrawable(drawables[random.nextInt(10)]);
